...
/* ── PAGE HEADER ── */
.page-hero {
    background: linear-gradient(135deg, var(--ink) 0%, var(--ink-mid) 55%, #1e3a5f 100%);
...
.hero-action:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(240,165,0,.35); }
...
.stat-label { font-size: 12px; font-weight: 600; color: var(--dim); }
...
.data-table th {
    ...
    color: var(--dim); background: #f8fafc;
    border-bottom: 1px solid var(--border);
}
.data-table td {
    padding: 12px 16px;
...
.badge-gold   { background: var(--gold-soft);color: #92400e;      border: 1px solid #fde68a; }
...
.log-text { font-size: 12.5px; color: var(--ink); line-height: 1.5; }
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div style="font-size:11px;color:var(--dim);">NIP: {{ $guru->nip ?? '-' }}</div>
                    </td>
                    <td>
                ...
                @empty
                <tr><td colspan="2" style="text-align:center;color:var(--dim);padding:20px;">Belum ada data.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
