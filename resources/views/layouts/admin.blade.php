...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sb-name { font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 700; color: #fff; }
        .sb-sub  { font-size: 10px; color: rgba(255,255,255,.3); margin-top: 1px; }
        ...
        .sb-link.active {
            ...
            color: #fff;
            font-weight: 700;
            box-shadow: 0 3px 10px rgba(240,165,0,.25);
        }
        ...
        .tb-page { font-size: 13px; font-weight: 700; color: var(--ink); }
        ...
        .tb-bell:hover { background: var(--surface); box-shadow: 0 2px 8px rgba(0,0,0,.08); }
        .tb-dot {
        ...
        .tb-uname { font-size: 12.5px; font-weight: 700; color: var(--ink); }
        .tb-urole { font-size: 10.5px; color: var(--dim); }
        ...
        .table-custom tbody tr:hover td { background: #fafbfc; }
        ...
        .badge-amber  { background: var(--abg); color: var(--amber); border: 1px solid var(--ab); }
        ...
        .btn-dark-custom:hover { opacity: .9; transform: translateY(-1px); color: #fff; }
        .btn-outline-blue { background: var(--bbg); color: var(--blue); border: 1px solid var(--bb); }
        .btn-outline-blue:hover { background: var(--blue); color: #fff; }
        .btn-outline-red  { background: var(--rbg); color: var(--red);  border: 1px solid var(--rb); }
        .btn-outline-red:hover  { background: var(--red); color: #fff; }
        .btn-outline-green{ background: var(--gbg); color: var(--green);border: 1px solid var(--gb); }
        .btn-outline-green:hover{ background: var(--green); color: #fff; }
        .btn-ghost-custom { background: #f8fafc; color: var(--dim); border: 1.5px solid var(--border); }
        .btn-ghost-custom:hover { background: var(--bg); }
        ...
        .warn-title { font-size: 12px; font-weight: 700; color: #92400e; margin-bottom: 8px; }
        ...
        .page-subtitle { font-size: 12px; color: var(--dim); margin-top: 3px; }
    ...
    <div class="sb-foot">
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <button type="submit" title="Logout"
                style="background:none;border:none;color:rgba(255,255,255,.3);font-size:17px;cursor:pointer;padding:4px;"
